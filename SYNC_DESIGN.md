...
| **v0.3.0** | `~/.bettercursor/unified.db` (§3) + snapshot codec (§2, bubbles / blob_refs / raw_blobs) + `Transport` trait 转 async (§4) + `Conflict` 5-way enum (§6) — 大版本, **推开 v0.2 旧 inline-write 路径** | 5-6d | ⚪ 待拍板 |
